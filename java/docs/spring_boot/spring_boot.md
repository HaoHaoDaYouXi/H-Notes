...
### <a id="ydyypz">`Spring Boot`约定优于配置</a>
...
### <a id="cshhjbl">`Spring Boot`初始化环境变量</a>
...
### <a id="pzjzsx">`Spring Boot`配置加载顺序</a>
...
### <a id="pzjzsx">`Spring Boot`多套不同环境配置</a>
...
### <a id="hxpzwj">`Spring Boot`核心配置文件</a>
...
### <a id="sxlbs">`Spring Boot`实现热部署</a>
主要有两种方式：
- `Spring Loaded`
...
### <a id="zdpzyl">`Spring Boot`自动配置原理</a>
