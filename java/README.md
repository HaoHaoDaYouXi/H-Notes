...
- [`Redis`集群的最大槽数是`16384`个](docs/redis/redis.md#16384)
- [`Redis`实现消息队列](docs/redis/redis.md#xxdl)
- [`pipeline`](docs/redis/redis.md#pipeline)
- [Redis分布式锁](docs/redis/redis_lock.md)
    - [Redis实现](docs/redis/redis_lock.md#redis)
    - [Redisson实现](docs/redis/redis_lock.md#redisson)
...
- [JDK版本管理](docs/other/jdk_manage.md)
- [日志](../wait.md)
- [Generator](../wait.md)
- [Lombok](../wait.md)
    - [Data](../wait.md)
